...
def lottery():
    '''This method simulates the powerball lottery.
        No input arguments.
        Returns: none.'''
    ...
    while True:
        ...
        # Check that the numbers are unique:  (Create a set from number to remove duplicates.)
    ...
    for i in range(numPlays):
        ...
        # Sets are not ordered, so it doesn't matter what order the integers in set(numbers) and set(winningNumbers) are.
